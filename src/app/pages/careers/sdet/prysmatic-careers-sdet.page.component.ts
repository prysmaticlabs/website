...
export class PrysmaticCareersSdetPageComponent {
  post: JobPost = {
    ...
    lookingFor: 'We are looking for a remote, full-time Devops Engineer to keep pushing the envelope on decentralized technologies. Particularly, having experience in infrastructure and deployments of software in critical functions.',
    requirements: [
      'Having worked on a team, participated in the design and code review process, and having not only shipped products, but successfully landed them',
