...
export class PrysmaticCareersSecurityPageComponent {
  post: JobPost = {
    ...
    lookingFor: 'We are looking for a remote, full-time security engineer to keep pushing the envelope on decentralized technologies. Particularly, having experience in computer security and penetration testing is a huge plus.',
    requirements: [
