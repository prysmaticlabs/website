...
const Intro = (props) => {
  return (
    <div className="intro">
      ...
      <p>We are implementing the first <a className="pink" href="https://github.com/ethereum/wiki/wiki/Sharding-FAQ">sharding</a> client for the go-ethereum project.</p>
      <p>Currently, blockchains do not scale. With Ethereum receiving over <i>a million transactions per day</i>, the network is desperate for a solution that will help sustain its massive growth and adoption.</p> 
  		<p>We are building out the first sharding implementation for the <a className="pink" href="https://github.com/ethereum/go-ethereum">Geth (go-ethereum)</a> client, allowing the system to process transactions at over 10x - 100x of its current speed!</p>
